...
## 1. Post principal (X/Bluesky — 280 chars ou menos)
...
**Tweet 1:** O problema: agentes de IA geram "AI slop" — gradiente roxo, 3 cards iguais, Inter. Solução: um pacote que dá ao agente o método de um setor de design real.

**Tweet 2:** 8 skills encadeadas com 2 checkpoints humanos: researcher → IA → ui-designer → redesign → critic → refine → a11y → handoff. O humano é o diretor, o agente é o setor.
...
- **Hacker News**: "Show HN: an entire design department as a package for AI agents"
- **Reddit**: r/ClaudeAI, r/artificial, r/webdev (ler as regras de self-promo)
- **Discord de agentes**: Claude Code, Codex communities
- **X/Twitter**: tags #buildinpublic #ClaudeCode #Codex #AIagents #designsystem
- **Dev.to**: blog post do processo (README EN já serve de base)

## 5. Timing sugerido

1. Push do repo + release v0.9.0 + ativar GitHub Pages
2. Verificar README renderizado + badges
3. Post no X/Bluesky (1-2h após push — o star velocity importa nas primeiras 48h)
4. Post no HN/Reddit/Dev.to nas 24-48h seguintes
5. Responder comentários e pedir feedback (engajamento alimenta o algoritmo)

## 6. Métricas de sucesso (1 semana)

- 50+ stars
- 10+ forks
- 5+ issues/feedbacks de qualidade
- 1+ usuário não-designer usando o kit